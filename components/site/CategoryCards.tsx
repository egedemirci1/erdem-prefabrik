  ...
  const categories = [
    {
      ...
      icon: Home,
      image: "/images/projects/1-URUN-GORSELLERI/1-PREFABRIK YAPILAR/1-EVLER/AYSE GUNER-YUNAK-137 CELIKEV/5_Photo - 4.jpg",
    ...
    },
    {
      ...
      icon: Package,
      image:
        "/images/projects/1-URUN-GORSELLERI/6-MODULER/OFIS/OFIS-SHOWROOM/bilinmeyenm2.JPG",
      href: "/moduler",
